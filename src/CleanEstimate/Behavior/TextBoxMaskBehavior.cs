...
namespace CleanEstimate.Behavior
{
    ...
    ///     Class Information:
    ///	    <list type="bullet">
    ///         <item name="authors">Authors: Kevin Bäker, Ruben Hakopian</item>
    ///         <item name="date">February 2010</item>
    ///     </list>
    /// </para>
    /// </remarks>
    #endregion
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                try
                {
                    ...
                    {
                        if (!text.Contains(NumberFormatInfo.CurrentInfo.NumberDecimalSeparator) && !text.Contains(NumberFormatInfo.CurrentInfo.NegativeSign))
                            text = "0";
                    }
                }
                catch
